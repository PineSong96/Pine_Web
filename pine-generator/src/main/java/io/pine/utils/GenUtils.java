...
package io.pine.utils;

import io.pine.entity.ColumnEntity;
import io.pine.entity.TableEntity;
...
public class GenUtils {
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("Detail.vue.vm")) {
            return "vue" + File.separator + className + "Detail.vue";
        }
        if (template.contains("Edit.vue.vm")) {
            return "vue" + File.separator + className + "Edit.vue";
        }
        return null;
    }
}
